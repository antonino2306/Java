...
public class TestAbbonati {
	...
	public static void main(String args[]) {
		...
		for (int i = 1; i < 10; i++) {
			...
			listaAbbonatiPremium.add(new AbbonatoPremium("", "", i*3, i*10));
		}
		...
		System.out.println("L'abbonato 2 della lista abbonati ha speso per il suo acquisto: " + listaAbbonati.get(1).acquista(20));
